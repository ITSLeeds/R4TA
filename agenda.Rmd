...
-  Spatial data with R (10:15 - 11:15) 
    - 15 minutes intro, 60 minutes hands-on with [Chapter 2](http://geocompr.robinlovelace.net/spatial-class.html) from **Geocomputation with R** [@lovelace_geocomputation_2018].
...
- An [introduction to stplanr](https://cran.r-project.org/web/packages/stplanr/vignettes/introducing-stplanr.html) (10:00 - 11:00) 
    - Practical: Section [7.3](https://geocompr.robinlovelace.net/transport.html#transport-zones) of Geocompr
